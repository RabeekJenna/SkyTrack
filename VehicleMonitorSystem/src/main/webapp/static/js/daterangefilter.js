 $(function () {
       ...
       $('#customer_dataTable thead tr.filters th').each(function () {
           var title = $(this).text();
        ...
        var table = $("#customer_dataTable").DataTable({
            ...
            responsive: true,
            "lengthMenu": [[10, 25, 25,20,20,20,-1], [10, 25, 25,20,20,20, "All"]],
            orderCellsTop: true,
            scrollX: true,
            colReorder: true,
            ...
            "initComplete": function (settings, json) {
                //  $("#customer_dataTable_processing").css("visibility", "hidden");
                $('#customer_dataTable').fadeIn();
            },
                

          
            "footerCallback": function( tfoot, data, start, end, display ) {
                var info = $('#customer_dataTable').DataTable().page.info();
        ...
        ($("#customer_dataTable_filter input").removeClass("input-sm"));
        ...
        $('.daterange').daterangepicker({
            ranges: {
                "Today": [moment(), moment()],
                'Tomorrow': [moment().subtract(1, 'days'), moment().add(1, 'days')],
       ...
       //get column index for date range
        ...
        $("#customer_dataTable_wrapper thead").on("mousedown", "th", function (event) {
